...
var (
	...
	regexSingleQuotesPath = regexp.MustCompile(`^'/[/ _.가-힣\w]+'$`)                                                                                                         // '/LIBRARY_3D/asset/'
	regexDoubleQuotesPath = regexp.MustCompile(`^"/[/ _.가-힣\w]+"$`)                                                                                                         // "/LIBRARY_3D/asset/"
	...
	regexNumbers          = regexp.MustCompile(`[0-9]+$`)                                                                                                                   // only number
